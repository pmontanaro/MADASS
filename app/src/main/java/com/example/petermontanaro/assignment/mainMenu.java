    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
       //         this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        ...
        layoutmang = new LinearLayoutManager(this);
        recycle_menu.setLayoutManager(layoutmang);
    ...
    private void loadMenu() {
        ...
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(Category.class, R.layout.menu_item, MenuViewHolder.class, category) {
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                Picasso.with(getBaseContext()).load(model.getImage()).into(viewHolder.img);
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                       // Toast.makeText(mainMenu.this, ""+clickItem.getName(), Toast.LENGTH_SHORT).show();
                        ...
                        //get category id to specify menu selection
                        Intent foodList = new Intent(mainMenu.this, FoodList.class);
                        // getKey of food
